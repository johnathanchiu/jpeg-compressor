...
def quantize(input, debug=False, c=False):
    ...
    q_c = np.array([[9, 11, 8, 8, 14, 20, 24, 13],
                    [12, 12, 13, 19, 22, 18, 17, 31],
                    [7, 13, 9, 24, 20, 19, 23, 56],
                    [6, 10, 22, 29, 51, 87, 80, 62],
                    [13, 22, 37, 40, 43, 30, 20, 27],
                    [15, 35, 21, 24, 39, 30, 19, 33],
                    [19, 41, 41, 42, 34, 33, 50, 51],
                    [20, 43, 44, 40, 40, 51, 52, 43]], dtype=np.float16)
